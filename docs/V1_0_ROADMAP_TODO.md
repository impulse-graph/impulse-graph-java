...
- [~] ~~**Live Ingestion & Streaming Mutation Architecture ([`docs/ingestion-strategies.md`](file:///Users/jesse/impulse/impulse-graph-java/docs/ingestion-strategies.md))**:~~ **SCRAPPED**. Impulse is now strictly read-only.
