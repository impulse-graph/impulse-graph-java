...
/**
 * Unit tests for ImpScheme sealed AST representation, S-expression parser, and
 * serializer.
 */
public class ImpScmAstTest {
	...
	void testRoundTripSerialization() {
		ScmProgram original = ScmProgram.of(ScmWalk.forward("userToGroup"),
	...
	void testReduceAndLiterals() {
		ScmProgram prog = ScmProgram.of(ScmWalk.reverse("deviceToNetwork"), ScmReduce.sum());
