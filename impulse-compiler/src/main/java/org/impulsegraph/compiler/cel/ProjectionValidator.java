...
/**
 * Semantic type-checker and optimizer for state projections. Enforces rules
 * around Late Materialization (IDs) vs Lightweight Payloads.
 */
			...
			switch (node.reducer()) {
				...
				case AND :
					throw new IllegalArgumentException(String.format(
							"Semantic Error: Cannot apply math/logic reducer '%s' to semantic ID expression in projection 'state.%s'",
