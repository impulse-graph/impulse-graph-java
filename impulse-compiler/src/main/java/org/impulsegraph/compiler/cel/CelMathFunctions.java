...
/**
 * Registry of 46 analytical vector math and FP classification functions for
 * CEL. Exactly matches impulse-cpp impulse_math_ops.h / impulse_cel.h.
 */
public final class CelMathFunctions {
	...
	private static final Map<String, Integer> MATH_MAP = Map.ofEntries(Map.entry("abs", MATH_FUNC_ABS),
			Map.entry("sqrt", MATH_FUNC_SQRT), Map.entry("rsqrt", MATH_FUNC_RSQRT), Map.entry("cbrt", MATH_FUNC_CBRT),
			Map.entry("pow", MATH_FUNC_POW), Map.entry("hypot", MATH_FUNC_HYPOT), Map.entry("lerp", MATH_FUNC_LERP),
			Map.entry("exp", MATH_FUNC_EXP), Map.entry("exp2", MATH_FUNC_EXP2), Map.entry("exp10", MATH_FUNC_EXP10),
			Map.entry("expm1", MATH_FUNC_EXPM1), Map.entry("log", MATH_FUNC_LOG), Map.entry("log2", MATH_FUNC_LOG2),
			Map.entry("log10", MATH_FUNC_LOG10), Map.entry("log1p", MATH_FUNC_LOG1P), Map.entry("sin", MATH_FUNC_SIN),
			Map.entry("cos", MATH_FUNC_COS), Map.entry("tan", MATH_FUNC_TAN), Map.entry("asin", MATH_FUNC_ASIN),
			Map.entry("acos", MATH_FUNC_ACOS), Map.entry("atan", MATH_FUNC_ATAN), Map.entry("atan2", MATH_FUNC_ATAN2),
			Map.entry("sinc", MATH_FUNC_SINC), Map.entry("sinh", MATH_FUNC_SINH), Map.entry("cosh", MATH_FUNC_COSH),
			Map.entry("tanh", MATH_FUNC_TANH), Map.entry("asinh", MATH_FUNC_ASINH), Map.entry("acosh", MATH_FUNC_ACOSH),
			Map.entry("atanh", MATH_FUNC_ATANH), Map.entry("floor", MATH_FUNC_FLOOR), Map.entry("ceil", MATH_FUNC_CEIL),
			Map.entry("trunc", MATH_FUNC_TRUNC), Map.entry("round", MATH_FUNC_ROUND),
			Map.entry("clamp", MATH_FUNC_CLAMP), Map.entry("copysign", MATH_FUNC_COPYSIGN),
			Map.entry("fmod", MATH_FUNC_FMOD), Map.entry("relu", MATH_FUNC_RELU),
			Map.entry("leaky_relu", MATH_FUNC_LEAKY_RELU), Map.entry("sigmoid", MATH_FUNC_SIGMOID),
			Map.entry("gelu", MATH_FUNC_GELU), Map.entry("silu", MATH_FUNC_SILU),
			Map.entry("softplus", MATH_FUNC_SOFTPLUS), Map.entry("erf", MATH_FUNC_ERF),
			Map.entry("erfc", MATH_FUNC_ERFC), Map.entry("lgamma", MATH_FUNC_LGAMMA),
