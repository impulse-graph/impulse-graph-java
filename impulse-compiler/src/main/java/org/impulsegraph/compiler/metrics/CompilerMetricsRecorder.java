...
public final class CompilerMetricsRecorder {
	...
	public long stage1Compilations() {
		return stage1Compilations.get();
	}
	public long stage2Compilations() {
		return stage2Compilations.get();
	}
	public long stage1DurationNanos() {
		return stage1DurationNanos.get();
	}
	public long stage2DurationNanos() {
		return stage2DurationNanos.get();
	}
	public long jitDurationNanos() {
		return jitDurationNanos.get();
	}
	public long compilationFailures() {
		return compilationFailures.get();
	}
	public ConcurrentHashMap<String, AtomicLong> passDurations() {
