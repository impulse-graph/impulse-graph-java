...
/**
 * Execution plan cache metrics recorder tracking hit ratios, misses, and
...
public final class PlanCacheMetricsRecorder {
	...
	public long planRebinds() {
		return planRebinds.get();
	}
	public long planEvictions() {
		return planEvictions.get();
	}
	public long activePlans() {
		return activePlans.get();
	}
	public long bytecodeMemoryBytes() {
		return bytecodeMemoryBytes.get();
	}
}
