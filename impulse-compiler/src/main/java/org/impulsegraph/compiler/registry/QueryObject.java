...
/**
 * Immutable registered query object encapsulating the Stage 1 normalized
 * ImpScheme AST and snapshot-bound executable CompiledQuery cache.
 */
