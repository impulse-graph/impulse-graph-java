...
/**
 * High-performance coordinator executing Stage 1 and Stage 2 compilation
 * pipelines with pass tracing and caching.
 */
public final class QueryCompilerEngine {
	...
	public CompilerMetricsRecorder compilerMetrics() {
		return compilerMetrics;
	}
	public PlanCacheMetricsRecorder planCacheMetrics() {
	...
	/**
	 * Executes Stage 2 (Snapshot-Bound) compilation binding a QueryObject to a
	 * target ImpulseGraphSnapshot.
	 */
	public CompiledQuery compileStage2(QueryObject queryObject, ImpulseGraphSnapshot snapshot, Arena arena,
