...
/**
 * Stage 2 Pass: Cost-based graph traversal direction selection (CSR forward vs
 * CSC reverse). Inspects relation structural statistics and CSC matrix presence
 * to pick the optimal walk direction.
 */
