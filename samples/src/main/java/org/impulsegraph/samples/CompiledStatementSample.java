...
/**
 * Demonstrates prepared statements for sub-microsecond parameterized query execution.
 */
public class CompiledStatementSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Arena arena = Arena.ofShared()) {
            ...
            // 1. Prepare declarative openCypher query once (compiles & optimizes to bytecode)
            String cypher = """
