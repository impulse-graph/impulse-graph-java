...
/**
 * Enterprise Health Check and Readiness Probe for Kubernetes and Spring Boot
 * Actuator deployments. Pure JDK 25 standard library without external framework
 * imports.
 */
