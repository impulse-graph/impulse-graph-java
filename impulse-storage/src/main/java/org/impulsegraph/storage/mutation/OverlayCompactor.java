...
public class OverlayCompactor {
     ...
     */
    public GraphSnapshot compactToDisk(Path newSnapshotFile, java.util.Map<String, String> extraMetadata) throws IOException {
        ...
        org.impulsegraph.storage.stats.StreamingStatsCollector statsCollector = new org.impulsegraph.storage.stats.StreamingStatsCollector();
        ...
        Map<String, org.impulsegraph.storage.csr.RelationSnapshot> compactedRelations = new LinkedHashMap<>();
        ...
        try {
            ...
            for (String rName : relationNames) {
                ...
                org.impulsegraph.storage.csr.RelationSnapshot compactedRel = new org.impulsegraph.storage.csr.RelationSnapshot(
