...
public final class VmStateLayout {
	...
	/**
	 * 8-byte fixed instruction layout: - opcode: byte (offset 0) - flags: byte
	 * (offset 1) - dst_reg: short (offset 2..3) - payload: int (offset 4..7)
	 */
	 ...
	 * - reserved: uint32 (offset 4) - flags: uint64 (offset 8) - registers:
	 * uint64[64] (offset 16..527) - register_types: uint8[64] (offset 528..591) -
	 * query_context: pointer (offset 592..599) - call_stack: uint32[8] (offset
	 * 600..631) - call_stack_depth: uint32 (offset 632..635) - reserved_padding2:
	 * uint32 (offset 636..639)
	 */
	public static final StructLayout VM_STATE_LAYOUT = MemoryLayout.structLayout(JAVA_INT.withName("pc"),
			JAVA_INT.withName("reserved"), JAVA_LONG.withName("flags"),
			MemoryLayout.sequenceLayout(64, JAVA_LONG).withName("registers"),
			MemoryLayout.sequenceLayout(64, JAVA_BYTE).withName("register_types"), ADDRESS.withName("query_context"),
