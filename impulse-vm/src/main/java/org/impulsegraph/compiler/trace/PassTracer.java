...
/**
 * Diagnostic pass execution tracer recording multi-pass S-expression
 * transformations.
 */
public final class PassTracer {

	public record PassTraceEntry(String passName, ImpScmNode beforeAst, ImpScmNode afterAst, long durationNanos) {
	}
