...
/**
 * Stage 2 Pass: Linear scan register allocator for ImpulseVM registers
 * (R0..R63).
 */
public final class RegisterAllocationPass implements CompilerPass {
	...
	public record RegisterAssignment(Map<ImpScmNode, Short> srcRegisters, Map<ImpScmNode, Short> dstRegisters,
	...
	public ImpScmNode transform(ImpScmNode ast, CompilerContext context) {
		...
		// Returns unchanged AST; register assignment metadata is attached or queried by
		// emitter
		return ast;
	}
