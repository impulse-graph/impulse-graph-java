...
/**
 * Impulse Graph Engine - Java 25 FFM ReBAC Access Control Benchmark. Measures
 * single-seed user authorization (Zanzibar style) vs 1.25M node seed expansion.
 */
public class RebacVmBenchmarkTest {
	...
	public void benchmarkJava25FfmRebac() throws Exception {
		...
		try (Arena arena = Arena.ofShared()) {
			...
			assertNotNull(graph, "ImpulseGraphSnapshot must be initialized");
			...
			// Scenario 1: Single User Seed ReBAC Permission Check (Realistic Zanzibar
			// Check)
			...
			// Scenario 2: 1.25M Active Node Expansion (Stress Benchmark over full 10M
			// Edges)
			...
			System.out.println(
					"| :-------------------------------------------- | --------------: | ------------------: |");
			System.out.printf("| %-45s | %12.2f us | %14.0f QPS |\n", "1-User Seed ReBAC Check (Zanzibar Check)",
					avgSingleUs, singleQps);
			System.out.printf("| %-45s | %12.2f us | %14.0f QPS |\n", "1.25M Node Seed Expansion (Full 10M Edges)",
					avgHeavyUs, heavyQps);
			System.out.println("=========================================================================\n");
		}
	}
