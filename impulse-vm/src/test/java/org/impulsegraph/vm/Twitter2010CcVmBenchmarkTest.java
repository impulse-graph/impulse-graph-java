...
public class Twitter2010CcVmBenchmarkTest {
	...
	public void runTwitter2010CcBenchmark() throws Throwable {
		if (!Files.exists(TWITTER_SNAPSHOT_PATH)) {
			System.out.println(
					"Twitter 2010 snapshot not found at " + TWITTER_SNAPSHOT_PATH + ", skipping CC benchmark.");
			return;
		}
		...
		try (Arena arena = Arena.ofShared()) {
			...
			System.out.printf("Micro-Latency per Component Label: %.3f us%n",
					(ccTimeMs * 1000.0) / Math.max(1, componentCount));
