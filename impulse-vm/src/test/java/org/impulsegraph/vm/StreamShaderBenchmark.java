...
public class StreamShaderBenchmark {
    ...
    public static void main(String[] args) {
        ...
        try (Arena arena = Arena.ofShared()) {
            ...
            offsets[0] = 0;
            offsets[1] = numEdges;
            for (int i = 2; i <= numNodes; i++) offsets[i] = numEdges;
            
            for (int i = 0; i < numEdges; i++) targets[i] = i + 1;
            ...
            ImpulseVmInterpreter.execute(prog, instructions.size(), mockGraph, null, arena);
