...
public class ImpulseQueryCompilerTest {
    ...
    public void testBlueGreenSnapshotRebindAndVerification() {
        try (Arena arena = Arena.ofShared()) {
            ...
            RelationSnapshot relU2gA = new org.impulsegraph.storage.csr.RelationSnapshot(arena, 2, 1, u2gOffsetsA, u2gTargetsA);
            ...
            RelationSnapshot relG2rA = new org.impulsegraph.storage.csr.RelationSnapshot(arena, 6, 1, g2rOffsetsA, g2rTargetsA);
            ...
            RelationSnapshot relU2gB = new org.impulsegraph.storage.csr.RelationSnapshot(arena, 2, 1, u2gOffsetsB, u2gTargetsB);
            ...
            RelationSnapshot relG2rB = new org.impulsegraph.storage.csr.RelationSnapshot(arena, 6, 1, g2rOffsetsB, g2rTargetsB);
    ...
    public void testBlueGreenVerificationFailureMissingRelation() {
        try (Arena arena = Arena.ofShared()) {
            ...
            RelationSnapshot relU2g = new org.impulsegraph.storage.csr.RelationSnapshot(arena, 1, 1, u2gOffsets, u2gTargets);
