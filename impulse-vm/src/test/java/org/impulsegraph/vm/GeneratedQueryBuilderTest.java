...
public class GeneratedQueryBuilderTest {
	...
	public void testStronglyTypedGeneratedQueryExecution() {
		try (Arena arena = Arena.ofShared()) {
			...
			// Execute strongly-typed generated builder query with IDE auto-complete
			// methods!
			ImpulseGraphQuery<ImpulseBitSet> query = MockUserQueryBuilder.from(0).walkUserToGroup().walkGroupToRole();
