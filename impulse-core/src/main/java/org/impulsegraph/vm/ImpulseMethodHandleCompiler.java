...
public final class ImpulseMethodHandleCompiler {
    ...
    static {
        try {
            INTERPRETER_EXECUTE_MH = LOOKUP.findStatic(
                    ...
                    "execute",
                    MethodType.methodType(Object.class, MemorySegment.class, long.class, GraphSnapshot.class, Object.class, Arena.class)
            );
     ...
     * Invoking the returned MethodHandle (GraphSnapshot, Object input, Arena) -> Object
