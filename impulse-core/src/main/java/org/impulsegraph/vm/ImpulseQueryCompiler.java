 ...
 * patch table. When graph snapshots are blue/green swapped, {@link CompiledQuery#rebind(GraphSnapshot)}
...
public final class ImpulseQueryCompiler {
    ...
    public static final class CompiledQuery {
        ...
        public CompiledQuery(MemorySegment programSeg, long instructionCount, List<RelationInstructionPatch> patches,
                             Map<String, Integer> relationIdMap, GraphSnapshot initialSnapshot, Arena arena) {
        ...
        public GraphSnapshot currentSnapshot() {
         ...
         */
        public void rebind(GraphSnapshot newSnapshot) {
         ...
         */
        public Object execute(GraphSnapshot snapshot, Object input, Arena executionArena) {
            ...
            GraphSnapshot targetSnapshot = state.snapshot();
     ...
     */
    public static CompiledQuery compile(List<StepNode> astSteps, GraphSnapshot snapshot, Arena arena) {
    ...
    private static short compileSubSteps(List<StepNode> subSteps, GraphSnapshot snapshot,
    ...
    private static RelationSnapshot findRelationInSnapshot(GraphSnapshot snapshot, String relName) {
    ...
    public static String disassembleQuery(ImpulseGraphQuery<?> query, ImpulseGraphSnapshot snapshot) {
        ...
        GraphSnapshot graph = DefaultImpulseQueryEvaluator.extractGraphSnapshot(snapshot);
