...
public final class ImpulseLayoutsV0_9 {
    ...
    public static final StructLayout IMPULSE_DOMAIN_CATALOG_ENTRY_HEADER_V0_9_T_LAYOUT = MemoryLayout.structLayout(
        ...
        ValueLayout.JAVA_SHORT_UNALIGNED.withName("name_len")
    ).withName("impulse_domain_catalog_entry_header_v0_9_t");

    public static final VarHandle VH_DOMAIN_ID =
        IMPULSE_DOMAIN_CATALOG_ENTRY_HEADER_V0_9_T_LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("domain_id"));
    public static final VarHandle VH_DOMAIN_KEY_TYPE =
        IMPULSE_DOMAIN_CATALOG_ENTRY_HEADER_V0_9_T_LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("key_type"));
    public static final VarHandle VH_DOMAIN_NAME_LEN =
        IMPULSE_DOMAIN_CATALOG_ENTRY_HEADER_V0_9_T_LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("name_len"));

    /** Section 2 Relation Directory Entry Descriptor (112 Bytes) */
    public static final StructLayout IMPULSE_RELATION_DIRECTORY_ENTRY_V0_9_T_LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(6, ValueLayout.JAVA_BYTE).withName("reserved2")
    ...
    public static final VarHandle VH_ATTR_NAME_LEN =
        IMPULSE_ATTRIBUTE_DESCRIPTOR_V0_9_T_LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("name_len"));
