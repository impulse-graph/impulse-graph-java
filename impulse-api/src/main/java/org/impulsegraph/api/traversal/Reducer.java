...
/**
 * Monoidic reduction operators applied when multiple traversal paths converge
...
public enum Reducer {
	...
	/**
	 * Standard arithmetic sum for PageRank, Markov walks, and edge weight
	 * accumulation.
	 */
	SUM,
	...
	/**
	 * Lexicographic Min-Witness (Vector Co-Scatter). Requires a parameterized
	 * field.
	 */
	ARGMIN,

	/**
	 * Lexicographic Max-Witness (Vector Co-Scatter). Requires a parameterized
	 * field.
	 */
	ARGMAX
}
