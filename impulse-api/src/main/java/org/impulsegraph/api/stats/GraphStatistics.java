...
/**
 * Aggregator holding statistics across all relations and attributes in a graph
 * snapshot.
 */
public class GraphStatistics {
	...
	public AttributeStatistics getAttributeStatistics(String attributeKey) {
		...
		for (Map.Entry<String, AttributeStatistics> entry : attributeStatsMap.entrySet()) {
			if (entry.getKey().equalsIgnoreCase(attributeKey) || entry.getKey().endsWith("." + attributeKey)
