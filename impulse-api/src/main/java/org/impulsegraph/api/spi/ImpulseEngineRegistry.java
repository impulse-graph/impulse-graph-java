...
/**
 * Registry coordinating discovery and access to the active {@link ImpulseEngineProvider}.
 */
public final class ImpulseEngineRegistry {
     ...
     *
     * @param provider the engine provider to set
     */
    ...
    /**
     * Retrieves the active engine provider, resolving via ServiceLoader or fallback if uninitialized.
     *
