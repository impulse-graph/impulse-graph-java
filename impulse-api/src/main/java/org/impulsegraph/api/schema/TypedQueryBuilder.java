...
/**
 * Strongly-typed base class for generated query builders. Wraps an underlying
 * {@link ImpulseQueryBuilder} while providing type-safe methods and IDE
 * auto-complete.
 *
 * @param <E>
 *            Current entity type (e.g. User, Group)
 * @param <R>
 *            Target return type
 */
