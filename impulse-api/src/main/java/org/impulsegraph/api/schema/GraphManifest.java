...
public record GraphManifest(String graphName, String version, Map<String, TablespaceDef> tablespaces,
		Map<String, DomainDef> domains, Map<String, RelationDef> relations,
