...
public record ScmReduce(Op op) implements ImpScmNode {
	...
	public enum Op {
		SUM, FIRST, COUNT, MIN, MAX, ARGMIN, ARGMAX
	}
	...
	public static ScmReduce sum() {
		return new ScmReduce(Op.SUM);
	}
	public static ScmReduce first() {
		return new ScmReduce(Op.FIRST);
	}
	public static ScmReduce count() {
		return new ScmReduce(Op.COUNT);
	}
	public static ScmReduce argmin() {
		return new ScmReduce(Op.ARGMIN);
	}
	public static ScmReduce argmax() {
		return new ScmReduce(Op.ARGMAX);
	}
