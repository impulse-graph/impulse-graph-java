...
/**
 * Fused 2-Hop CSR Graph Traversal Step: (csr-walk-2hop rel1 rel2). Fuses two
 * sequential forward CSR traversals into a single hardware register execution
 * loop, eliminating intermediate frontier bitset materialization.
 */
public record ScmWalk2Hop(String relation1Name, int relation1Id, String relation2Name,
		int relation2Id) implements ImpScmNode {
