 ...
 */
public sealed interface ScmLiteral extends ImpScmNode
		permits ScmLiteral.ScmInt, ScmLiteral.ScmFloat, ScmLiteral.ScmBool, ScmLiteral.ScmString {
	...
	static ScmInt ofInt(long value) {
		return new ScmInt(value);
	}
	static ScmFloat ofFloat(double value) {
		return new ScmFloat(value);
	}
	static ScmBool ofBool(boolean value) {
		return new ScmBool(value);
	}
	static ScmString ofString(String value) {
		return new ScmString(value);
	}
	static ScmString ofStr(String value) {
		return new ScmString(value);
	}
}
